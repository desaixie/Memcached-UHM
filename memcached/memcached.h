...
struct settings {
  ...
  SSL_CTX *ssl_ctx;     /* holds the SSL server context which has the server
                           certificate */
...
extern item *getFromMap(const char *str);
extern void endMap();
extern void startMap(size_t size);
extern item *removeFromMap(const char *str);
extern bool insertIntoMap(const char *str, item *d);
extern bool setInMap(const char *str, item *d);
extern void resizeMap(unsigned size);
